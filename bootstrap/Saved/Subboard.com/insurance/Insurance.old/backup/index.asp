...
/*				display: inline-block;
	...
	<body>
		...
		<div id='content'>
			...
			<p><font color=red><font size=+1>The window for Fall 2012 waivers is now open.</font></font></p>
			<p>Waiving Health Insurance - <a href='domestic_waive.asp'>Please click here</a> to verify your private health insurance meets or exceeds the University at Buffalo requirements for attendance and to proceed to ON-LINE WAIVER</p>

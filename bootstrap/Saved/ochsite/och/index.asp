        ...
        <script type='text/javascript'>
            ...
            function slide1()
            {
                var htmlString = 
                        ...
                        "<p><a href='#' onClick='readMore1();' style='font-weight:bold;'>Read More ...</a></p>"+


			"<input class='float-right' type='button' id='closeBtnInit' value='Close' />";
			
                $div.html(htmlString);
                $("#simplemodal-container").css("height","auto");
                $div.modal({autoResize: true});
		
                $("#closeBtnInit").click(function() {

        ...
        <script type='text/javascript'>
            ...
            function readMore1()
            {
                var htmlString = 
                        ...
                        "<input class='float-right' type='button' onClick='slide2();' value='Next >>' />";
                $div.html(htmlString);
                $("#simplemodal-container").css("height","340px");
            }
            ...
            function slide2()
            {
                var htmlString = 
                    ...
                    "<p>There are two primary categories for housing:</p>"+
                    "<p><ul><li>Complex Living - Multiple Unit Dwellings</li></ul></p>"+
                    "<p><ul><li>Standard Rental Homes - Usually 1-2 unit family homes</li></ul></p>"+
                    "<h2>Types of Apartments</h2>"+
                    "<p><ul><li>House Rentals</li></ul></p>"+
                    "<p><ul><li>Apartment/Flat Rentals</li></ul></p>"+
                    "<p><ul><li>Room Rentals</li></ul></p>"+
            ...
            {
                var htmlString = 
                        "<h2>Different Apartment Types</h2>"+
                        "<p>House Rentals - renting of the entire building.</p>"+
                        "<p>Apartment/Flat Rentals- Renting of one portion of a building</p>"+
                        "<p>Room Rentals - Renting of one specific bedroom with shared common areas in an unit</p>"+
                        "<input class='float-right' type='button' onClick='slide2();' value='Next >>' />";
                $div.html(htmlString);
                $("#simplemodal-container").css("height","340px");
            }
               ...
               function readMore3()
            {
                var htmlString = 
                        "<h2>Primary Costs</h2>"+
                        "<p>Rent: pay on time or additional fees may be accessed.</p>"+
                        "<p><ul><li>Utilities - Heat, Gas, Electric, Water.</li></ul></p>"+
                        "<p><ul><li>Food: Meal plan? Cooking? Eating Out?</li></ul></p>"+
                        "<p><ul><li>Transportation - Car? Bus? Walking? Biking? Etc...</li></ul></p>"+
                        "<h2>Secondary Costs</h2>"+
                        "<p>Insurance, laundry, extracurricular, furnishings, luxury items </p>"+
                        "<input class='float-right' type='button' onClick='slide2();' value='Next >>' />";
                $div.html(htmlString);
                $("#simplemodal-container").css("height","340px");
            }
            ...
            function slide4()
            {
                var htmlString = 
                    ...
                    "<p>5. <a href='rental-checklist.pdf'>See Renter's Checklist</a></p>"+
            ...
            function slide5()
            {
                var htmlString = 
                    ...
                    "<p><a href='http://subboard.com/legal/' onClick='readMore5();'>Read More ...</a></p>"+
            ...
            function slide6()
            {
                var htmlString = 
                    ...
                    "<input class='float-right modalCloseImg simplemodal-close' type='button' value='Close' />";
                $div.html(htmlString);
                $("#simplemodal-container").css("height","445px");
            }

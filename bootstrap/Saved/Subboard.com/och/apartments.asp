...
<%	do until apartments.eof %>
				<div class='apartment'>
					...
					<a href='<%= apartments("tracker_url") %>'><img src='/och/resources/images/listing_images/<%= apartments("image_id") %>.jpg'></a>
					<div class='address'><%= apartments("address") %></div>
					<div class='phone'><%= apartments("phone") %></div>
					<a href='<%= apartments("tracker_url") %>'><%= apartments("url") %></a>
